...
public class ServentMain {
	...
	public static void main(String[] args) {
		...
		appInfo.setId(AppConfig.myServentInfo.getId());
		appInfo.setIpAddress(AppConfig.myServentInfo.getIpAddress());
		appInfo.setPort(AppConfig.myServentInfo.getListenerPort());
		appInfo.setNeightbors(AppConfig.myServentInfo.getNeighbors());


		switch (AppConfig.MUTEX_TYPE) {
			case SUZUKI_TOKEN:
				mutex = new SuzukiTokenMutex(appInfo);
				break;
			default:
				mutex = null;
