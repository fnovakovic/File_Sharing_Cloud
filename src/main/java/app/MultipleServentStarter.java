...
public class MultipleServentStarter {
	...
	private static void startServentTest(String testName) {
		...
		AppConfig.readConfig("C:\\Users\\filip\\Desktop\\kids_proj_Filip_Novakovic_rn8820\\" +testName +"/servent_list.properties");
		...
		for(int i = 0; i < serventCount; i++) {
			try {
				ProcessBuilder builder = new ProcessBuilder("java", "-cp", "target/classes/", "app.ServentMain",
						"C:\\Users\\filip\\Desktop\\kids_proj_Filip_Novakovic_rn8820\\" + testName+"/servent_list.properties", String.valueOf(i));
				
				//We use files to read and write.
				//System.out, System.err and System.in will point to these files.
				builder.redirectOutput(new File("C:\\Users\\filip\\Desktop\\kids_proj_Filip_Novakovic_rn8820\\" +testName+"/output/servent" + i + "_out.txt"));
				builder.redirectError(new File("C:\\Users\\filip\\Desktop\\kids_proj_Filip_Novakovic_rn8820\\" + testName+"/error/servent" + i + "_err.txt"));
				builder.redirectInput(new File("C:\\Users\\filip\\Desktop\\kids_proj_Filip_Novakovic_rn8820\\" + testName+"/input/servent" + i + "_in.txt"));
	...
	public static void main(String[] args) {
		startServentTest("file_sharing_example");
	}
