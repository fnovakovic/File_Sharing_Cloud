...
public class AskForFileHandler implements MessageHandler {

    private Message clientMessage;
    private SuzukiTokenMutex suzukiTokenMutex;

    public AskForFileHandler(Message clientMessage, DistributedMutex tokenMutex) {
    ...
    @Override
    public void run() {
        //aktiviramo metodu za trazenje fajla
        suzukiTokenMutex.findFile(clientMessage.getName(),clientMessage.getOriginalSenderInfo().getId());
    }
}